...
class Comment {
  String username; // Fixed typo here
  String text;
...
class _TikTokCloneState extends State<TikTokClone>
  ...
  List<Comment> comments = [
    Comment('Usaame', 'Share what are you thoughts about our app!'),
    Comment('Caabi', ' You Can comment here '),
    Comment('Jamaal', 'ReAct our videos with love'),
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            ...
                            Comment newComment =
                                Comment('Harun Abdi Saciid', commentText);
                            setState(() {
            ...
            icon: Container(
              ...
              child: Icon(Icons.add,
                  color: const Color.fromARGB(
                      255, 255, 255, 255)), // Black icon color
            ),
            label: 'Upload',
          ),
          BottomNavigationBarItem(
